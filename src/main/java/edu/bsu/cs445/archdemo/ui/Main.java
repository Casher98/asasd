...
import edu.bsu.cs445.archdemo.ContentDmModule;
...
public class Main extends Application {
    ...
    public void start(Stage primaryStage) {
        ...
        Injector injector = Guice.createInjector(new ContentDmModule());
        DomaDataParser parser = injector.getInstance(DomaDataParser.class);
